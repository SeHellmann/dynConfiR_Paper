...
setwd(script_path)
save(recovery_collected_results, file="saved_results.RData")
# load("saved_results_dynavite.RData")
# load("collected_fits_models_RMs.RData")
# recovery_collected_results <- c(recovery_collected_results_dynavite, recovery_collected_results_RMs)
